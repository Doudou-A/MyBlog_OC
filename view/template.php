...
<html>
		  ...
		  <div class="collapse navbar-collapse" id="navbarCollapse">
		    <ul class="navbar-nav mr-auto">
		      ...
		      <li class="nav-item">
		       ...
		       <li class="nav-item">
		        <div class="nav-link admin-btn" id="Administration">Administration
				  <div style="display: none;" class="d-flex flex-column aqua-gradient" id="AdministrationElement">
					<btn class="admin-btn p-3 font-weight-bold" id="BlogsPosts" >Articles
					...
					<btn class="admin-btn p-3 border-primary border-top font-weight-bold" id="Administrators">Utilisateurs
	...
	<script type="text/javascript">
			...
			var AdministrationElement = document.getElementById('AdministrationElement');
