		       ...
		       <li class="nav-item">
		        <div class="nav-link admin-btn" id="Administration">Administration</div>
				  <div class="d-flex flex-column aqua-gradient">
					<btn style="display: none;" class="admin-btn p-3 font-weight-bold" id="BlogsPosts" >Articles
					...
					<btn style="display: none;" class="admin-btn p-3 border-primary border-top font-weight-bold" id="Comments">Commentaires
					...
					<btn style="display: none;" class="admin-btn p-3 border-primary border-top font-weight-bold" id="Administrators">Utilisateurs
